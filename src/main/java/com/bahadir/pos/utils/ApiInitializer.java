...
//            Permission management = Permission.builder().name("Management").label("sys.menu.management").icon("ic-management").type(PermissionType.GROUP).route("management").orderValue(5).build();
            ...
            Permission systemIndex = Permission.builder().name("Management").label("sys.menu.management.index").icon("solar:widget-5-bold-duotone").type(PermissionType.GROUP).route("management").orderValue(6).build();
            Permission systemOrganization = Permission.builder().name("Organization").label("sys.menu.management.organization").type(PermissionType.MENU).route("organization").component("/management/system/organization/index.tsx").orderValue(1).parent(systemIndex).build();
            Permission systemPermission = Permission.builder().name("Permission").label("sys.menu.management.permission").type(PermissionType.MENU).route("permission").component("/management/system/permission/index.tsx").orderValue(2).parent(systemIndex).build();
            Permission systemRole = Permission.builder().name("Role").label("sys.menu.management.role").type(PermissionType.MENU).route("role").component("/management/system/role/index.tsx").orderValue(3).parent(systemIndex).build();
            Permission systemUser = Permission.builder().name("User").label("sys.menu.management.user").type(PermissionType.MENU).route("user").component("/management/system/user/index.tsx").orderValue(4).parent(systemIndex).build();
            Permission systemUserDetail = Permission.builder().name("User Detail").label("sys.menu.management.user_detail").type(PermissionType.MENU).route("user/:id").component("/management/system/user/detail.tsx").hide(true).orderValue(5).parent(systemIndex).build();

            Permission systemManagementIndex = Permission.builder().name("System").label("sys.menu.system.index").icon("solar:shield-user-outline").type(PermissionType.GROUP).route("system").orderValue(7).build();
            Permission systemManagementSession = Permission.builder().name("Sessions").label("sys.menu.system.session").type(PermissionType.MENU).route("session").component("/system/session/index.tsx").orderValue(1).parent(systemManagementIndex).build();
            Permission systemManagementLog = Permission.builder().name("Logs").label("sys.menu.system.log").type(PermissionType.MENU).route("log").component("/system/log/index.tsx").orderValue(2).parent(systemManagementIndex).build();

            //            Permission managementSession = Permission.builder().name("Menu Level 1b").label("sys.menu.menulevel.1b.index").type(PermissionType.GROUP).route("menu-level-1b").orderValue(2).parent(managementIndex).build();
//            Permission menuLevel2a = Permission.builder().name("Menu Level 2a").label("sys.menu.menulevel.1b.2a").type(PermissionType.MENU).route("menu-level-2a").component("/menu-level/menu-level-1b/menu-level-2a/index.tsx").orderValue(1).parent(managementSession).build();
//            Permission menuLevel2b = Permission.builder().name("Menu Level 2b").label("sys.menu.menulevel.1b.2b.index").type(PermissionType.GROUP).route("menu-level-2b").orderValue(2).parent(managementSession).build();
...
//            // Components İzinleri
//            Permission components = Permission.builder().name("Components").label("sys.menu.components").icon("solar:widget-5-bold-duotone").type(PermissionType.GROUP).route("components").orderValue(8).build();
...
//
//            // Functions İzinleri
//            Permission functions = Permission.builder().name("Functions").label("sys.menu.functions").icon("solar:plain-2-bold-duotone").type(PermissionType.GROUP).route("functions").orderValue(9).build();
...
//                    .build();
            ...
            permissionRepository.saveAll(List.of(home, pos,
                    ...
                    categories, categoryAdd, categoryEdit, categoryOrder, categoryList, /*dashboard, welcome, analysis, workbench, management,*/
                    userIndex, userProfile, userAccount,
                    systemIndex, systemOrganization, systemPermission, systemRole, systemUser, systemUserDetail,
                    systemManagementIndex, systemManagementLog, systemManagementSession,
                    calendar
//                    components, icon, animate, scroll, markdown, editor, multiLanguage, upload, chart, toast, functions, clipboard, tokenExpired,
//                    menuLevel2a, menuLevel2b, menuLevel3a, menuLevel3b,
//                    kanban, disabled, label, frame, externalLink, iframe, blank
            ));
